...
# print(get_invalids((1, 1111)))

# print(is_fake(1234))  # False
# print(is_fake(1123))  # False
# print(is_fake(1212))  # True
# print(is_fake(474747))  # True
# print(is_fake(12341234))  # True